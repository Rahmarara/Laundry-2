...
<div class="modal fade" id="hapusOutlet<?=$o->id_outlet?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <?=form_open('admin/hapus_outlet')?>
            Yakin menghapus data ini ?
            <input type="hidden" name="id_outlet" value="<?=$o->_id_transaksi?>">
        </div>
